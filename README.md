...
[![Rodar Script](https://img.shields.io/badge/Rodar%20Script-GitHub%20Pages-yellow?style=for-the-badge&logo=javascript)](https://gabrie1tk.github.io/CalcMedia_JavaScript/)
...
2.  Responda às caixas de alerta (**Prompts**) que aparecerão na tela inserindo as notas.
...
1.  Clone o repositório:
    ```bash
    git clone [https://github.com/Gabrie1Tk/CalcMedia_JavaScript.git](https://github.com/Gabrie1Tk/CalcMedia_JavaScript.git)
    ```
2.  Abra o arquivo `index.html`.
3.  Abra o Console do Navegador (`F12`) para interagir com o código.
